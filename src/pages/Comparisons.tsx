          ...
          <div style={{
            ...
            <div>
              ...
              >
                ...
                <option value="хорек">🦡 Хорёк</option>
              </select>
            </div>
            <div>
                      ...
                      {selectedFeedsData.map(feed => {
                        ...
                        return <td key={feed.id} style={{ 
                          ...
                          {typeof displayValue === 'number' ? (() => {
                            ...
                            if (key === 'phosphorus') {
                              return (displayValue * 10).toFixed(0); // мг/100г
                            } else if (key === 'calcium') {
